## Welcome to the AI Museum Scavenger Hunt!
This is your personalized guide to exploring the vast collection of The Met! This tool curates a custom list of artworks based on your interest, turning your visit into a fun, focused scavenger hunt.

### Generate your scavenger hunt here: https://ai-museum-scavenger-hunt.vercel.app/

### Getting Started
<img width="891"  alt="landing" src="assets/scavenger-hunt-frontend-landing.png" />
...
<img width="891" alt="map" src="assets/scavenger-frontend-map.png" />

#### 4. Print it Out

After you generate your map, you can

* Print Map: Print the map to take with you.

* Generate Another Map: Start over with a new topic.

<img width="891" alt="map" src="assets/scavenger-frontend-print.png" />
...
## Experiment (on a separate branch)
